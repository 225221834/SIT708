...
public final class ItemPlaylistBinding implements ViewBinding {
  ...
  private ItemPlaylistBinding(@NonNull MaterialCardView rootView, @NonNull ImageButton btnDelete,
  ...
  public static ItemPlaylistBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPlaylistBinding((MaterialCardView) rootView, btnDelete, tvVideoUrl);
    }
