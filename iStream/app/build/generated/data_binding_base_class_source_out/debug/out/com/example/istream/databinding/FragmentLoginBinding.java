...
public final class FragmentLoginBinding implements ViewBinding {
  ...
  private FragmentLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull Button btnSignUp, @NonNull TextInputEditText etPassword,
      @NonNull TextInputEditText etUsername, @NonNull TextInputLayout txtPassword,
      @NonNull TextView txtTitle, @NonNull TextInputLayout txtUsername) {
  ...
  public static FragmentLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLoginBinding((ConstraintLayout) rootView, btnLogin, btnSignUp, etPassword,
          etUsername, txtPassword, txtTitle, txtUsername);
    }
